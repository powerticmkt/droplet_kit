...
describe DropletKit::ProjectResource do
  ...
  RSpec::Matchers.define :match_project_fixture do |expected|
    match do |actual|
      ...
      expect(actual.uuid).to eq('c177dc8c-12c1-4483-af1c-877eed0f14cb')
  ...
  describe '#all' do
    it 'returns all of the projects' do
      ...
      expect(default.uuid).to eq('ec104091-d6d3-41b6-b803-780156de20ae')
    ...
    context 'when empty' do
      it 'returns an empty array of projects' do
        ...
        projects = resource.all.map(&:uuid)
  ...
  describe '#find' do
    it 'returns a singular tag' do
      ...
      project = resource.find(uuid: 'c177dc8c-12c1-4483-af1c-877eed0f14cb')
  ...
  describe '#delete' do
    it 'deletes a project' do
      ...
      resource.delete(uuid: 'c177dc8c-12c1-4483-af1c-877eed0f14cb')
  ...
  describe '#list_resources' do
    it 'list resources in the specified project' do
      ...
      resources = resource.list_resources(uuid: 'c177dc8c-12c1-4483-af1c-877eed0f14cb')
